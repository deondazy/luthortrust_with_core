...
return [
    ...
    'twig' => [
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | The template to use for error 404 pages
        |
        */
        'error_404_template' => '404.twig',
        'error_template_path' => __DIR__ . '/../src/Exceptions/views/',
        ...
        |--------------------------------------------------------------------------
        |
        | The template to use for error 500 pages
        |
        */
        'error_500_template' =>  '500.twig',
    ],
];
